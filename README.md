...
- 40x40 mm board size, 30.5x30.5 mm mounting holes
...
### Software?
AM32 for the ESCs, custom firmware for the rest. I have most parts working on the previous prototype (ESP32 S3 with 8520 brushed motors)